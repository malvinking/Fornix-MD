...
module.exports = {
  ...
  //_________________________________________________________________________________________________________________________________
  SUDO: process.env.SUDO || "923256245454",
  //_________________________________________________________________________________________________________________________________
  ...
  BRANCH: "main",
  //_________________________________________________________________________________________________________________________________
  STICKER_DATA: "🇪🇬🤬𝐑o͜͡M̸i͜͡🥀𝐊i͜͡n̸𝙂🇵🇰🦅",
  //_________________________________________________________________________________________________________________________________
  ...
  //_________________________________________________________________________________________________________________________________
  OWNER_NAME: process.env.OWNER_NAME || "𓄂☠️𝐑o͜͡M̸i͜͡🤴🏻𝐊i͜͡n̸𝙂🇵🇰༗",
  //_________________________________________________________________________________________________________________________________
  OWNER_NUMBER: process.env.OWNER_NUMBER || "923256245454",
  //_________________________________________________________________________________________________________________________________
  BOT_NAME: process.env.BOT_NAME || "𖤐𓊈⍨⃝💀⃟𝗥𝗢𝗠𝗜⃟🤴🏻⃢⃟𝗞ᶦ𝗡𝗚😈☣︎⃟➤𓊉𖤐",
  //_________________________________________________________________________________________________________________________________
